...
from grafeas.models.hash_hash_type import HashHashType  # noqa: F401,E501
...
class ApiHash(object):
    ...
    def value(self, value):
        ...
        :type: str
        """
        if value is not None and not re.search('^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$', value):  # noqa: E501
