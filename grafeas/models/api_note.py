...
class ApiNote(object):
    ...
    def __init__(self, name=None, short_description=None, long_description=None, kind=None, vulnerability_type=None, build_type=None, base_image=None, package=None, deployable=None, discovery=None, related_url=None, expiration_time=None, create_time=None, update_time=None):  # noqa: E501
