...
class Occurrence(object):
    ...
    """
    def __init__(self, name=None, resource_url=None, note_name=None, kind=None, custom_details=None, vulnerability_details=None, build_details=None, derived_image=None, installation=None, deployment=None, discovered=None, remediation=None, create_time=None, update_time=None, operation_name=None):
        """
